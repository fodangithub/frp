...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&dashboardAddr, "dashboard_addr", "", "127.0.0.1", "dasboard address")
	rootCmd.PersistentFlags().IntVarP(&dashboardPort, "dashboard_port", "", 7500, "dashboard port")
